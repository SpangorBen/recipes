...
<div class="bg-gray-900 min-h-screen flex items-center justify-center" style="background-image: url(pics/bgfood.jpg); background-position:center; background-repeat:no-repeat; background-size:cover">
  ...
  <div class="bg-[#2C3B55]/70 flex-1 flex flex-col space-y-5 lg:space-y-0 lg:flex-row lg:space-x-10 max-w-6xl sm:p-6 sm:my-2 sm:mx-4 sm:rounded-2xl" style="background-image: url(../images/wallvapor.jpg); background-position:center;
  ...
  border: 1px solid rgba(255, 255, 255, 0.3);">
    <!-- Navigation -->
    <div class="bg-[#A50012]/90 px-2 lg:px-4 py-2 lg:py-10 sm:rounded-xl flex lg:flex-col justify-between" style="">
      <nav class="flex items-center flex space-x-2 lg:space-x-0 lg:flex-col lg:space-y-2">
        <a class="text-white/50 p-4 inline-flex justify-center rounded-md hover:bg-[#FF5516] hover:text-white smooth-hover" href="tags">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 20 20" fill="currentColor">
            <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
          </svg>
        </a>
        <!-- Active: bg-gray-800 text-white, Not active: text-white/50 -->
        <a class="bg-[#FF5516] text-white p-4 inline-flex justify-center rounded-md" href="#">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 20 20" fill="currentColor">
            <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" />
          </svg>
        </a>
        <a class="text-white/50 p-4 inline-flex justify-center rounded-md hover:bg-[#FF5516] hover:text-white smooth-hover" href="#">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div class="flex items-center flex-row space-x-2 lg:space-x-0 lg:flex-col lg:space-y-2">
        ...
        <a class="text-white/50 p-4 inline-flex justify-center rounded-md hover:bg-[#FF5516] hover:text-white smooth-hover" href="../pages/logout">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="flex-1 px-2 sm:px-0">
      ...
      <div class="mb-8 sm:mb-0 mt-10 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <div class="group bg-gray-900/30 py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/40 hover:smooth-hover">
          ...
          <a class="text-white/50 group-hover:text-white group-hover:smooth-hover text-center" href="#" onclick="openMyPopup()">Add Recipe</a>
        </div>
